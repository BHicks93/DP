...
(function($){
    $.fn.glitch = function(options) {
        var s = $.extend({
            ...
            maxint: 5,     // max interval between glitchings
            minint: 0,      // min interval between glitchings
            maxglitch: 10,   // max number of twitches
            hshift: 600,      // max horizontal shift 
            vshift: 300,      // max vertical shift
        ...
        return this.each(function(){
            ...
            var g = function(){
                ...
                setTimeout(function(){$c.css({left: 0, top:0})}, 100);
                setTimeout(g, (rnd((s.maxint-s.minint))+s.minint)*100);
            }
            setTimeout(g, 100);
        });
    }
